...
export const getThreeRandomProducts = createAsyncThunk(
  'allProducts/getThreeRandomProducts',
  getThreeRandomProductsThunk
)
...
const allProductsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getThreeRandomProducts.pending, (state) => {
        state.isLoading = true
      })
      .addCase(getThreeRandomProducts.fulfilled, (state, { payload }) => {
        state.isLoading = false
        state.featured_products = payload
      })
      .addCase(getThreeRandomProducts.rejected, (state, { payload }) => {
        state.isLoading = false
        state.error = payload
        toast.error(payload)
      })
